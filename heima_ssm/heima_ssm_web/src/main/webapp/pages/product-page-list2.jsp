...
<head>
    ...
    <title>product-page-list2</title>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline" id="changePageSize" onchange="changePageSize()">
                            总共2 页，共14 条数据。 每页
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}" aria-label="Next">下一页</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}">尾页</a></li>
                        </ul>
                    </div>
